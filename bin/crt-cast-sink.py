...
# each builds its own side: stdin, line-buffered CHANNEL<TAB>TEXT lines
# (SEE/SAY/MARK). Full protocol and guarantees witnessed by
# tests/test_cast_sink.py's own docstring and cases.
import os
import sys
import subprocess
