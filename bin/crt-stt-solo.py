...
# tested by tests/test_sideband_wiring.py.
...
# judge). Opt-in, default OFF: with CRT_WAKE_ARM_ENABLED unset, wake_arm
# is never imported and publish_arm_window() below is a true no-op.
