...
# line was never implemented -- books.db held every scanned book's data
# all along, with no way to see it (crt-book-game-stats.py is a distinct
# concern: aggregate STT-training stats). Zero Claude/API calls -- pure
# local sqlite reads. See tests/test_book_catalog.py; NOT yet hardware-
# verified against real scanned data.
