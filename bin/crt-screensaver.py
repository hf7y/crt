...
def art_layout(art, width, height, reserve_caption=True):
    ...
    # cut_to_width keeps the leading columns and drops whatever falls past
    # the edge -- see test_screensaver_safe_margins.py::
    # TestArtLayoutWidthClip.test_a_line_wider_than_the_screen_is_cut_not_wrapped.
