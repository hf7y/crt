...
# addressed to Claude); grades it via crt-book-game.py's grade_answer().
import calendar
...
def main():
    ...
    # row), and log_training_row's own write -- see crt_loop_guard.py's
    # LoopGuard docstring for the per-iteration-catch pattern this uses.
