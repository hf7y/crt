#!/usr/bin/env python3
# Keep a nightly-batch report answerable (2026-07-25). Zach replies inline,
# anchored by section heading + quoted line -- a repeated heading breaks
# that anchor. The nested-cycle case that motivated this is witnessed by
# tests/test_report_lint.py::test_the_real_nested_cycle_shape_is_caught.
# Reports live in ~/reports/crt/, outside the repo.
#
