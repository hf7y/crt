#!/usr/bin/env python3
# vault:crt/PARKING-LOT.md's "speculative/optimistic response": an instant local
...
def pick_filler_line(rng=None):
    ...
    not a broken promise -- vault:crt/PARKING-LOT.md's sketch floated per-category
