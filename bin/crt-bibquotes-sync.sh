...
##
# NON-API-BY-DESIGN, preserved: crt-book-idle-bait.py never hits the network
# at render time. This script keeps the local copy fresh separately -- by
# hand, cron, or --daemon, never from the render path.
set -uo pipefail
