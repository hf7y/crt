...
# (2026-07-25). This tool stands in for Zach's own ear (FOCUS.md, the
# nightly-batch skill), so its verdicts carry weight -- see play_tone()'s
# and baseline_noise_floor()'s docstrings for why "played, not heard" and
# "never played" must not collapse into the same NOT DETECTED.
