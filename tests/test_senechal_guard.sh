...
# notify-senechal automatically, in case I forget." The two failure modes
# tested are opposite: staying SILENT on a change that owes a note, and NAGGING on read-only inspection.
set -uo pipefail
