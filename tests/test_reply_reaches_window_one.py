...
# and bin/crt-claude-bridge.py writes Claude's by tailing Claude Code's
# LOCAL session transcript under ~/.claude/projects/.
#
...
# nothing writes to. The reply was spoken and never written down, on a
# screen the console had just switched to on purpose.
#
# The other half matters just as much: with a LOCAL brain the bridge IS
# doing this job, and mirroring here too would double every line.
