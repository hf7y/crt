...
# actually runs. Neither is about what is under test here: chime() shares
# crt-announce.sh's rate limit (its own comment says why) and execs the real
# crt-earcon.sh, faked at PATH below. CRT_IDLE_SEEN is pinned too.
