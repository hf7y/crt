...
# crt-book-console.py already reads) -- landing on `book` left the console stuck there, since book's own return-to-idle logic only fires when book itself grabbed focus, not when handed it externally.
import os
import subprocess
import sys
import unittest
