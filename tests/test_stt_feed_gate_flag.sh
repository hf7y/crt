...
# test_stt_feed_secretary_flag.sh doesn't either) -- exercises the real addressed_to_console() bash function extracted verbatim, confirming the default-off guard and gate call site survive a refactor.
set -uo pipefail
fail=0
